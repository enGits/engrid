...
bl_info = {
    "name": "Export to snappyHexMesh (snappyHexMeshDict)",
    "author": "Oliver Gloth (enGits GmbH)",
    "version": (1, 0),
    "blender": (2, 6, 3),
    "location": "File > Export > snappyHexMesh (snappyHexMeshDict)",
...
###### EXPORT OPERATOR #######
class Export_snappy(bpy.types.Operator, ExportHelper):
    bl_idname = "export_shape.snappy"
    bl_label = "Export snappyHexMesh (snappyHexMeshDict)"
    filename_ext = ".begc"
