/*=========================================================================
  ...
  Module:    $RCSfile: vtksmoothpolydatafilter2.h,v $
...
=========================================================================*/
// .NAME vtkSmoothPolyDataFilter2 - adjust point positions using Laplacian smoothing
// .SECTION Description
// vtkSmoothPolyDataFilter2 is a filter that adjusts point coordinates using 
...
#ifndef __vtkSmoothPolyDataFilter2_h
#define __vtkSmoothPolyDataFilter2_h

#include "vtkPolyDataAlgorithm.h"

class vtkSmoothPoints;

class VTK_GRAPHICS_EXPORT vtkSmoothPolyDataFilter2 : public vtkPolyDataAlgorithm
{
public:
  vtkTypeRevisionMacro(vtkSmoothPolyDataFilter2,vtkPolyDataAlgorithm);
  ...
  static vtkSmoothPolyDataFilter2 *New();
...
private:
  vtkSmoothPolyDataFilter2(const vtkSmoothPolyDataFilter2&);  // Not implemented.
  void operator=(const vtkSmoothPolyDataFilter2&);  // Not implemented.
};
